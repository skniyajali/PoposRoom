...
import com.niyaj.ui.parameterProvider.DeliveryReportPreviewData.sampleDeliverReports
...
class DeliveryReportPreviewParameter : PreviewParameterProvider<List<DeliveryReport>> {
    override val values: Sequence<List<DeliveryReport>>
        get() = sequenceOf(sampleDeliverReports)
}

object DeliveryReportPreviewData {
    val sampleDeliverReports = listOf(
        DeliveryReport(
            orderId = 1,
