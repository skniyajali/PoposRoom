...
package com.niyaj.ui.parameter_provider
 ...
 */
class AddOnItemPreviewParameterProvider : PreviewParameterProvider<List<AddOnItem>> {
    override val values: Sequence<List<AddOnItem>>
        get() = sequenceOf(
            listOf(
                AddOnItem(
                    itemId = 1,
