...
object MarketListItemModule {

    @Provides
    fun provideMarketListItemRepository(
        marketListDao: MarketListWIthItemsDao,
        @Dispatcher(PoposDispatchers.IO) ioDispatcher: CoroutineDispatcher,
    ): MarketListItemRepository {
        return MarketListItemRepositoryImpl(marketListDao, ioDispatcher)
    }
}
