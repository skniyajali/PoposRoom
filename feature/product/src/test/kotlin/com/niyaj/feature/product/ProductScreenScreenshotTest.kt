...
import com.niyaj.feature.product.createOrUpdate.AddEditProductScreenContent
import com.niyaj.feature.product.createOrUpdate.AddEditProductState
import com.niyaj.feature.product.createOrUpdate.defaultTagList
import com.niyaj.feature.product.details.ProductDetailsScreenContent
import com.niyaj.feature.product.details.ProductTotalOrderDetails
import com.niyaj.feature.product.settings.DecreaseProductPriceScreenContent
import com.niyaj.feature.product.settings.ExportProductScreenContent
import com.niyaj.feature.product.settings.ImportProductScreenContent
import com.niyaj.feature.product.settings.IncreaseProductPriceScreenContent
import com.niyaj.feature.product.settings.ProductSettingScreenContent
...
class ProductScreenScreenshotTest {
    ...
    fun showSearchBarAndGetEmptyResult() {
        composeTestRule.captureForPhone("ShowSearchBarAndGetEmptyResult") {
            PoposRoomTheme {
                ProductScreenContent(
                    uiState = Success(productList.searchProducts("search")),
                    categories = categoryList,
                    selectedCategory = 0,
                    selectedItems = listOf(),
                    showSearchBar = true,
    ...
    fun productDetailsScreenPopulated() {
        composeTestRule.captureForPhone("ProductDetailsScreenPopulated") {
            PoposRoomTheme {
                ProductDetailsScreenContent(
                    productState = Success(productList.first()),
                    orderDetailsState = Success(productWiseOrder),
